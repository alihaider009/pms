<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		{
			$query = mysqli_query($db, "UPDATE supplier SET name='$name' , email='$email' , contact_no='$contact_no' , address='$address' , gender='$gender' , 
					cname='$cname' , bday='$bday' WHERE eid='$id' ");
			if($query)
				{
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Update supplier</h2>
              </div>
            </div>
				...
				?>
					...
					<div class="form-row">
						...
						<div class="form-group col-md-8">
							...
							<input type="text" class="form-control" name="cname" id="inputZip" value="<?php echo $row['cname'];?>">
						</div>
					</div>
					<div class="form-group">
