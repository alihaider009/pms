<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		{
			$query = mysqli_query($db, "UPDATE customer SET name='$name' , email='$email' , contact_no='$contact_no' , address='$address' , gender='$gender' , 
					mname='$mname' , bday='$bday' WHERE cid='$id' ");
			if($query)
				{
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Update Customer</h2>
              </div>
            </div>
				...
				?>
					...
					<div class="form-row">
						...
						<div class="form-group col-md-8">
							<label for="inputZip">Medicine name</label>
							<input type="text" class="form-control" name="mname" id="inputZip" value="<?php echo $row['mname'];?>">
						</div>
					</div>
					<div class="form-group">
