<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		}else
		{
			...
			{
				$query = mysqli_query($db, "INSERT INTO supplier (sid,name,email,contact_no,address,gender,cname,bday)VALUES (NULL,'$name', '$email', '$contact_no' , '$address' , '$gender' , '$cname' , '$bday')");
				if($query)
				{
				...
				<form action="" method="POST">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-8">
							...
							<input type="text" class="form-control" name="cname" id="inputZip">
						</div>
					</div>
					<div class="form-group">
